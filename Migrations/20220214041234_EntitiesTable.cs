...
{
    public partial class EntitiesTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobTitle = table.Column<string>(type: "varchar(200)", nullable: false),
                    ...
                    DateFirst = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateLast = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
